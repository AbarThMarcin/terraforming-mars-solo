...
const ModalDraftBtnChangeCorp = ({ dispatchGame, statePlayer, dispatchPlayer }) => {
   ...
   const handleClickChangeCorpBtn = () => {
      ...
      dispatchPlayer({ type: ACTIONS_PLAYER.CHANGE_PARAMETERS_REQUIREMENTS, payload: -statePlayer.globParamReqModifier })
      // Reset game state
